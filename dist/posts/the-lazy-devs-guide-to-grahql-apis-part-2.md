---
title: The lazy dev's guide to GraphQl APIs - Part one.
description: since it was created at facebook, It's taken the developer ecosystem by storm and has grown and been embeded into multiple systems and frameworks that are favorites of many developers today. Let's take a quick glipse at creating basic APIs with graphql using Graphql Yoga
date: '2023-03-20'
taglist:
    - graphql
    - graphql yoga
