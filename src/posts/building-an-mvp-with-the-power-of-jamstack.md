---
title: Building an MVP with the power of JamStack - using React, Hygraph, Netlify Identity and Netlify Functions
description: sometimes we want to flesh out that awesome Idea we have but the development time could be terrifying, in this article, I teach you how to build a minimum viable product for you idea using exisiting powerful jamstack technologies that shrink the time it will take for you with more robust architectures while giving the same quality. 
date: '2023-03-20'
taglist:
    - jamstack
    - react
...
<iframe height="500" style="width: 70%;" scrolling="no" title="Piccalilli CSS Utility — Issue  #2 — Full bleed utility" src="//codepen.io/andybelldesign/embed/Nmxrwv/?height=300&theme-id=dark&default-tab=css,result" frameborder="no" allowtransparency="true" allowfullscreen="true">
