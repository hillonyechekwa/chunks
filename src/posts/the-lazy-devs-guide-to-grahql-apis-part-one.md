---
title: The lazy dev's guide to GraphQl APIs - Part two.
description: we've looked at building graphql APIs using The Guild's Graphql Yoga, let's look at building APIs with Apollo's Graphql Server Framework.
date: '2023-03-20'
taglist:
    - graphql
    - apollo server
